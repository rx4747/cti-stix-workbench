...
import type { ObjectTypeDefinition, StixCatalog, StixCatalogData } from "./types";
...
class StandardStixCatalog implements StixCatalog {
  ...
  constructor(data: StixCatalogData) {
    ...
    this.version = `${frozenData.standard.toLowerCase().replaceAll(" ", "-")}-errata01`;
...
export const stixCatalog: StixCatalog = new StandardStixCatalog(STIX_2_1_CATALOG_DATA);
