...
import { canonicalizeJson, createDeterministicScoId } from "../src/core/sco-id";
...
const completeScoExamples = {
  ...
  file: {
    ...
    name: "example.bin",
    parent_directory_ref: "directory--b62644b5-8413-5f9f-9bb2-9c4d2bc24155",
  },
  ...
  "windows-registry-key": {
    ...
    values: [{ data: "example", data_type: "REG_SZ", name: "ExampleValue" }],
  },
  "x509-certificate": {
